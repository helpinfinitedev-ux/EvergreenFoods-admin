...
export const adminAPI = {
  ...
  receiveCustomerPayment: (data: { driverId?: string; customerId?: string; companyId?: string; amount: number; method: "CASH" | "BANK"; bankId?: string }) => api.post(`/admin/receive-payment`, data),
